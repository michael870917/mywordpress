 ...
 * @since 2.6.0
 */
define('AUTH_KEY', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry'); // Cambia esto por tu frase aleatoria.
define('SECURE_AUTH_KEY', 'Ipsum has been the industrys standard dummy'); // Cambia esto por tu frase aleatoria.
define('LOGGED_IN_KEY', 'when an unknown printer took a galley of type and scrambled it to make a type specimen book'); // Cambia esto por tu frase aleatoria.
